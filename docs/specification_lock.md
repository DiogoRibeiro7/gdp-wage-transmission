...
### The publication releases deliberately have no lock of their own

v0.8.1 onwards correct the manuscript, the report formatter and repository metadata. It changes no file under `src/wage_transmission`
