...
def test_repository_analysis_lock_verifies() -> None:
    """The committed Paper 2 lock must match the committed working tree."""
    lock = Path("papers/wage_distribution_breaks/analysis_lock.json")
